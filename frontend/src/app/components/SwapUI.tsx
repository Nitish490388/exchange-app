            ...
            <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col px-3">
                    <div className="flex flex-col flex-1 gap-3 text-baseTextHighEmphasis">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex flex-col relative">
                                <input step="0.01" placeholder="0" className="h-12 rounded-lg border-2 border-solid border-baseBorderLight bg-[var(--background)] pr-12 text-right text-2xl leading-9 text-[$text] placeholder-baseTextMedEmphasis ring-0 transition focus:border-accentBlue focus:ring-0" type="text" value="134.38" onChange={handleChange}/>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col relative">
                            <input step="0.01" placeholder="0" className="h-12 rounded-lg border-2 border-solid border-baseBorderLight bg-[var(--background)] pr-12 text-right text-2xl leading-9 text-[$text] placeholder-baseTextMedEmphasis ring-0 transition focus:border-accentBlue focus:ring-0" type="text" value="123" onChange={handleChange}/>
                            <div className="flex flex-row absolute right-1 top-1 p-2">
                                <div className="relative">
                    ...
                    </div>
                    {
                        ...
                        <>
                        <button type="button" className="font-semibold  focus:ring-blue-200 focus:none focus:outline-none text-center h-12 rounded-xl text-base px-4 py-2 my-4 bg-orange-600 text-greenPrimaryButtonText active:scale-98" data-rac="">Sell</button>
