...
export const MarketBar = ({market}: {market: string}) => {
    ...
    useEffect(() => {
        // console.log('Fetching ticker for market:', market);
        const signalingManager = SignalingManager.getInstance(); 
        // console.log('Signaling Manager:', signalingManager); // Log the instance
    
        if (!signalingManager) {
            console.error('SignalingManager instance is undefined');
            return;
        }
    
        getTicker(market).then(setTicker);
    
        signalingManager.registerCallback("ticker", (data: Partial<Ticker>) => 
...
function Tickker({market}: {market: string}) {
